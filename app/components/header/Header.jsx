  ...
  render() {
    return (
      <div>
        ...
        >
          <Link to="/profile" className="menu-links"><MenuItem primaryText="My Profile" leftIcon={<ProfileIcon />} onClick={this.closeLeftNav}/></Link>
          {ClientAuth.isAdminUser() && <Link to="/search" className="menu-links"><MenuItem primaryText="Search" leftIcon={<SearchIcon />} onClick={this.closeLeftNav}/></Link>}
          <Link to="/" className="menu-links"><MenuItem primaryText="Sign out" leftIcon={<LogoutIcon />} onClick={this.logout}/></Link>
        </Drawer>
      </div>
    );
  }
